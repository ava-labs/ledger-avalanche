...
[![GithubActions](https://github.com/zondax/ledger-avalanche/actions/workflows/main.yaml/badge.svg)](https://github.com/Zondax/ledger-avalanche/blob/main/.github/workflows/main.yaml)
...
Download a release from here (https://github.com/Zondax/ledger-avalanche/releases). You only need `installer_s.sh`
