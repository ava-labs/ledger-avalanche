...
mod tests {
    ...
    // taken from obsidian app
    const DATA: &[u8] = &[
        0x00, 0x00, 0x00, 0x00, // Network ID (fuji)
        0x00, 0x00, 0x00, 0x05, // Blockchain ID (fuji)
        ...
        0x94, 0xf7, // number of outputs
        0x00, 0x00, 0x00, 0x02, // transferrable output 1
        0x3d, 0x9b, 0xda, 0xc0, 0xed, 0x1d, 0x76, 0x13, 0x30, 0xcf, 0x68, 0x0e, 0xfd, 0xeb, 0x1a,
        0x42, 0x15, 0x9e, 0xb3, 0x87, 0xd6, 0xd2, 0x95, 0x0c, 0x96, 0xf7, 0xd2, 0x8f, 0x61, 0xbb,
        0xe2, 0xaa, // 32-byte asset ID
        ...
        0x7F, 0x67, 0x1C, 0x73, 0x0D, 0x48, 0x07, 0xC2, 0x9E, 0xA1, 0x9B, 0x19, 0xA2, 0x3C, 0x70,
        0x0B, 0x19, 0x8F, 0x8B, 0x51, // 20-byte address
        ...
        0x00, 0x00, 0x00, 0x01, // threshold
        0x00, 0x00, 0x00, 0x01, // number of addresses
        0xA4, 0xAF, 0xAB, 0xFF, 0x30, 0x81, 0x95, 0x25, 0x99, 0x90, 0xA9, 0xE5, 0x31, 0xBD, 0x82,
        0x30, 0xD1, 0x1A, 0x9A, 0x2A, // 20-byte address
        // number of inputs
        0x00, 0x00, 0x00, 0x02, // transferrable input 1
        0x1C, 0x03, 0x06, 0xE5, 0x8B, 0x75, 0x4E, 0xEB, 0x92, 0xE7, 0xA5, 0x79, 0xC5, 0x9A, 0x69,
        0x33, 0x23, 0xCD, 0x99, 0x94, 0xA5, 0x94, 0x61, 0x62, 0x72, 0x6F, 0x3B, 0x68, 0x0E, 0x9E,
        0x48, 0x34, // 32-byte TX ID
        ...
        0x29, 0x71, 0x0D, 0xE0, 0x93, 0xE2, 0xF4, 0x10, 0xB5, 0xA3, 0x5E, 0x2C, 0x60, 0x59, 0x38,
        0x39, 0x2D, 0xA0, 0xDE, 0x80, 0x2C, 0x74, 0xE2, 0x5D, 0x78, 0xD2, 0xBF, 0x11, 0x87, 0xDC,
        0x9A, 0xD6, // 32-byte TX ID
        0x00, 0x00, 0x00, 0x00, // UTXO index
        0x3d, 0x9b, 0xda, 0xc0, 0xed, 0x1d, 0x76, 0x13, 0x30, 0xcf, 0x68, 0x0e, 0xfd, 0xeb, 0x1a,
        0x42, 0x15, 0x9e, 0xb3, 0x87, 0xd6, 0xd2, 0x95, 0x0c, 0x96, 0xf7, 0xd2, 0x8f, 0x61, 0xbb,
        0xe2, 0xaa, // 32-byte asset ID
